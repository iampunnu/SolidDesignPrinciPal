package MainFunction.designpattern.vendingMachine.state;

import MainFunction.designpattern.vendingMachine.Coin;
import MainFunction.designpattern.vendingMachine.Item;
import MainFunction.designpattern.vendingMachine.VendingMachine;
...
public class SelectionState implements State {
    ...
    public void chooseProduct(VendingMachine machine, int codeNumber) throws Exception{
        ...
        if(paidByUser < item.getPrice()) {
            ...
            if(paidByUser > item.getPrice()) {
                double integer=paidByUser-item.getPrice();
